  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'FAQ', link: 'faqs' },
      {
        ...
        link: 'https://www.youtube.com/playlist?list=PLX2nBoWRisnXWhC2LD9j4jV0iFzQbRcFX',
      },
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          {
            text: 'Solver',
            link: '/Modeling/solver',
            items: [
              { text: 'Backend Info', link: '/Modeling/backendInfo' },
              {
                text: 'Command Line Options',
                link: '/Modeling/cmdLineOptions',
              },
