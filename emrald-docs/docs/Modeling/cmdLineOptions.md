...
## Option Flags
  ...
  | -jsonStats | Writes path statistics to JSON output file at specified directory |
...
## Options JSON File
Alternatively, the user may create a dedicated .json file to specify options. The options file has the following format:<br>
