...
Open the Diagram where you would like your event to appear. Locate the State you would like to add the event to and right-click on the "Events" label. Click "New Event". <br> 
...
Creating an event by right-clicking on the Events tab, marks the event so it will be listed in this tab. Drag and drop the event onto the "Events Actions" header of the desired state to add it as you would an existing event.
...
In the Left Navigation Frame, locate the event you would like to reuse. Click and hold on to the event and drag it to the Event Actions section until it highlights green. Release your mouse button.<br>

::: tip Note
Use the tabs to more easily find the desired event.
"Local" items were created in the current diagram.
"Global" items were created from the side bar tab for use in any/all diagrams. 
...
## Editing an Event
**Option 1:** <br> 
On the Left Navigation Frame, click on the tab (either All, Global, or Local) where your event is located. If you are not sure which tab, click on the All tab. Right-click on the event and click "Edit properties".<br>
...
**Continued for both options:**<br>
In the Event Editor window, the common fields among all event types are Name, Description, Type, and the option to Exit Parent state when event is triggered. Each will be described below.
...
The event will no longer be listed in the state and will be deleted from the entire model, and no longer will be listed in the Left Navigation Frame. To only remove it from this state, use "[Remove Event](#removing-an-event)" instead. <br>
...
To define the type of event, click the drop-down menu in the Event Editor, and then click the desired event type.<br> 
...
Listed as Var Condition in the drop-down menu, this event monitors variable values with user-defined code to determine event execution.</br>
...
<img src="/images/Modeling/events/StateChangeOptions.png" alt="State Change Options" width="500"/>
  ...
  In the Left Navigation Frame, locate the state you would like to monitor. Click and hold on to the event and drag it to the States list title until the row highlights green and release your mouse button.<br> 
...
<h3>Component Logic <img src="/images/Modeling/events/compLogic.png" alt="Component Logic" width="25"/></h3>
  ...
  - **Logic Top:** Click the field to expand the drop-down menu containing all of your Logic Trees. Click on the Logic Tree you would like evaluated when the event is triggered.
  
<h3>External Simulation <img src="/images/Modeling/events/ExtInput.png" alt="External Simulation" width="25"/></h3>
  Listed as Ext. Simulation in the drop-down menu. This event is triggered when the assigned variable is modified by and external simulation and the evaluation code returns true.<br>
...
## Time-based Events
  ...
  Time-based events have the option to be *persistent*, meaning they will retain their time after the state is exited if the event is not triggered.<br>
...
<h3>Failure Rate <img src="/images/Modeling/events/dice.png" alt="Failure Rate" width="25"/></h3>
  ...
  - **Lambda/Freq:** The frequency (instances) of this event occurring per the time rate defined. Likely a decimal value like 0.0003. If you choose to have it as a static value, leave the checkbox unchecked, and type the value into the field. If you choose to have it as a variable value, check the checkbox, and click the field to reveal the drop-down menu of variables available in your model. Select the variable to set it.
...
<h4>Normal Distribution </h4>
  Listed as Normal Distribution in the Distribution Type drop-down menu, this distribution samples a normal distribution according to user specified parameters for when this event will occur from the time entering the state
  <br><br>
...
<br>
  ...
  - **Minimum:** Enter the minimum value of the function; if a sampling returns a value less than this, then this time will be used. (Typically zero as you cannot take no time to do something.)
...
<br>
  ...
  - **Rate:** Enter the value of the rate. To the right of the value is a drop-down menu that includes various time units. Click the drop-down menu to expand it and click the unit you would like to use for that value.
...
<img src="/images/Modeling/events/WeibullDistributionOptions.png" alt="Weibull Distribution Options" width="500"/>
  ...
  - **Time Scale:** Click the drop-down menu to expand it and click the unit you would like to use for this distribution. 
...
<h4>Gompertz Distribution </h4>
  <p>This option samples a Gompertz distribution given shape, scale, minimum, and maximum values to generate a value of when the event occurs.</p>
