...
Listed as "Ext. Sim Message" in the drop-down menu. This action sends a message to an external code through coupled communication messaging protocol. See [Coupling Protocols](./couplingProtocols.md) for details on coupling code to EMRALD.
