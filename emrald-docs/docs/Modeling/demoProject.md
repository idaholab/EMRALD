...
A demonstration project is loaded immediately upon opening EMRALD.
...
Upcoming sections of the documentation will detail how the model is set up to move between states via events, transition actions, and other structures. The [Types of Diagrams](./diagrams.md#types-of-diagrams) section explains the dynamics of the component and system diagrams within the context of this demo project.

Below is a table outlining what acronyms are used in diagram names, event names, or action names.
|Name|Description|
|---|---|
