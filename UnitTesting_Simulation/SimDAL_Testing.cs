...
namespace UnitTesting_Simulation
{
  ...
  public class SimDAL_Testing
  {
    ...
    public void FailRateEventTest()
    {
      ...
      //Is there a way to easily test the triggering of the event 
      //test for true
      TimeSpan s = ev.NextTime(TimeSpan.FromSeconds(0), null);
    ...
    public void NormDistEventTest()
    {
      ...
      //Is there a way to easily test the triggering of the event 
      //test for true
      Assert.True(ev.NextTime(TimeSpan.FromSeconds(0), null).TotalMilliseconds == 45286473.5153);
      //test for false
      //Assert.False(ev.EventTriggered());
    ...
    public void LogNormDistEventTest()
    {
      ...
      //Is there a way to easily test the triggering of the event 
      //test for true
      Assert.True(ev.NextTime(TimeSpan.FromSeconds(0), null).TotalMilliseconds == 29869832.9832);
      //test for false
      //Assert.False(ev.EventTriggered());
