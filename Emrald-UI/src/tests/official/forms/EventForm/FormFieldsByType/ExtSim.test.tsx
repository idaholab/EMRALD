...
describe('ExtSim Events', () => {
  test('selects event type', async () => {
    ...
    await user.click(
      await findByRole(await screen.findByLabelText('External Event Type'), 'combobox'),
    );
    await user.click(await screen.findByRole('option', { name: 'Simulation End' }));
  ...
  test('sets variable change', async () => {
    ...
    await user.click(await screen.findByRole('option', { name: 'Variable Change' }));
    ...
    await user.click(
      await findByRole(await screen.findByLabelText('External Sim Variable'), 'combobox'),
    );
    await user.click(await screen.findByRole('option', { name: 'Test ExtSim Variable' }));
