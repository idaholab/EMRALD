...
namespace EMRALD_Sim
{
  public partial class FormMultiThreadRefs : Form
  {
    ...
    private string _origModelPath = null; //origional location for the model without the model name

    public MultiThreadInfo EditedMultiThreadInfo => _multiThreadInfo;

    public FormMultiThreadRefs(MultiThreadInfo multiThreadInfo, List<string> issueItems, string origModelPath)
    {
      InitializeComponent();
